...
export const updateTaskPositionToApi = (event: any) => {
  ...
  else
  {
    ...
    /* positionをふり直す */
    const updateTasksList: TaskType[] = _cloneDeep(toParentElement)
